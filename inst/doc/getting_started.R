...
## ----EDA 1,  echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE--------------
...
## ----EDA 2, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE---------------
...
## ----EDA 3, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE---------------
...
## ----EDA 4,  echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE--------------
...
## ----EDA 5,  echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE--------------
...
## ----Univariate 1,  echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE-------
...
## ----Univariate 2,  echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE-------
# Perform ANOVA comparisons test (example with 2 cytokines)
cyt_anova(data_df[, c(1:2, 5:6)], format_output = TRUE)

## ----Multivariate 1, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE------
# cyt.plsda function. 
...
## ----Multivariate 2, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE------
...
## ----EDA 6, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE---------------
...
## ----EDA 7, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE, fig.width=5, fig.height=4----
# Generating Heat map
...
## ----EDA 8, echo=TRUE, warning=FALSE, message=FALSE, cache=TRUE---------------
